			...
			<div class="card-body">
				<form action="" method="POST" enctype="multipart/form-data">
					<div class="d-flex justify-content-end mb-3">
						<button class="btn btn-primary mx-1" type="submit" name="save" value="save">Update</button>
							...
							<div class="row">
								<div class="col-12">
									<div class="mb-3">
										...
										<input type="text" class="form-control seo_input" name="title" id="i_title" value="<?= $row->title ?>" placeholder="Title Page" required>
									</div>
									<div class="mb-3">
							...
							<div class="row">
								<div class="col-xl-6 col-lg-6 col-12">
									<div class="mb-3">
										...
										<input type="text" class="form-control seo_input" name="seo_slug" id="seo_slug" value="<?= $row->seo_slug ?>" required>
									</div>
									<div class="mb-3">
								...
								<div class="col">
									<div class="card border" style="background: #f9f9f9;">
										<div class="card-body">
											<h4 class="m-0" style="color: #1a0cab;" id="title_rev"><?= $row->title ?></h4>
											<div style="color: #006622;" id="slug_rev"><?= $row->seo_slug ?></div>
