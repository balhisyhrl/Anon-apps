	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				<div class="row mb-2">
					<div class="col-sm-4">
						<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#modal-add" class="btn btn-success mb-2"><i class="mdi mdi-plus-circle me-2"></i> New Category</a>
					</div>
					<div class="col-sm-8">
								...
								<td class="table-action">
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-end">
											...
											<a href="<?= base_url("admin/tags/delete/$c->id") ?>" class="delete-confirm dropdown-item"> <i class="mdi mdi-delete"></i> Delete</a>
										</div>
									</div>
								</td>
							</tr>
...
<div id="modal-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="<?= base_url("admin/tags/edit") ?>" method="post">
...
<script>
	...
	function edit(id) {
		...
		$("#content-modal-edit").load("<?= base_url("admin/tags/edit/") ?>" + id)
	}
</script>