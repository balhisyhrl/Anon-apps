								...
								<td class="table-action">
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-end">
											<a href="<?= base_url("admin/users/$u->id/owned") ?>" class="dropdown-item"> <i class="uil-folder-check"></i> Owned</a>
											<a href="<?= base_url("admin/users/$u->id/badge") ?>" class="dropdown-item"> <i class="uil-sign-left"></i> Badge</a>
											<a href="<?= base_url("admin/users/edit/$u->id") ?>" class="dropdown-item"> <i class="mdi mdi-square-edit-outline"></i> Edit</a>
											<a href="<?= base_url("admin/users/delete/$u->id") ?>" class="delete-confirm dropdown-item"> <i class="mdi mdi-delete"></i> Delete</a>
										</div>
									</div>
								</td>
							</tr>
