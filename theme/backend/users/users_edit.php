			...
			<div class="card-body">
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" name="username" value="<?= $row->username ?>" placeholder="Full Name" required autocomplete="off">
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<textarea name="bio" class="form-control" rows="10"><?= $row->bio ?></textarea>
					</div>
				</form>
			</div>
		</div>
