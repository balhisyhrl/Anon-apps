...
<div class="row">
	<div class="col-xl-3 col-lg-3 col-12">
		<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			<a class="nav-link active show"" id=" siteinfo-tab" data-bs-toggle="pill" href="#siteinfo" role="tab" aria-controls="siteinfo" aria-selected="true">
				<span>Site Info</span>
			</a>
			...
			<div class="card">
				<div class="card-body">
					...
					<div class="tab-content" id="v-pills-tabContent">
						<div class="tab-pane fade active show" id="siteinfo" role="tabpanel" aria-labelledby="siteinfo-tab">
							<div class="mb-3">
