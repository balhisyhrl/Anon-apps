...
<head>
    ...
    <?= meta_tag([
        'title' => "UPDATE PASSWORD - " . $websettings->seo_title,
        'description' => '',
                ...
                <div class="single-form-wrap">
                    <div class="inner-wrap">
                        ...
                        <div class="auth-head">
                            ...
                            <p>Create a password that is easy to remember.</p>
                        </div>
                                ...
                                <div class="login-form">
                                    <div class="field">
                                        <div class="control has-icon">
                                            <input class="input" type="text" placeholder="New Password" name="password" required>
                                    ...
                                    <div class="control login">
                                        <button type="submit" class="button h-button is-primary is-bold is-fullwidth is-raised">UPDATE PASSWORD</button>
                                    </div>
                                </div>
                            </form>
                        </div>
